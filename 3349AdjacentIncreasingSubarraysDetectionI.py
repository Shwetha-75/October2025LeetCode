...
determine whether there exist two adjacent subarrays of 
length k such that both subarrays are strictly increasing. 
Specifically, check if there are two subarrays starting at 
...
class TestApp:
    ...
    def testCaseThree(self):
        assert Solution().hasIncreasingSubarrays([5,8,-2,-1],2)==True        